...
public class PublishActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAddBlog = findViewById(R.id.btn_add_blog);
            ...
            if (images != null && !images.isEmpty()) {
                for (String path : images) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        uri = Uri.parse(path); // 新版本直接用返回的路径
                    } else {
    ...
    private void addAddButtonItem() {
        ...
        btn.setOnClickListener(v -> requestPermissionAndOpenGallery());
    ...
    private void doPublishBlog(String model, String context, int userId, List<String> urlList) {
        ...
        NetClient.post(ApiConstant.BLOG_ADD, req, new NetCallBack() {
            @Override
